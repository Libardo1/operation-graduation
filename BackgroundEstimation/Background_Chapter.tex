...
\begin{figure}[hbt]
  \includegraphics[width=0.5\linewidth]{/Users/caitlinmalone/Documents/Thesis/BackgroundEstimation/images/mbb_bbb_bbloose_bbanti_r200-215.pdf}
  \includegraphics[width=0.5\linewidth]{/Users/caitlinmalone/Documents/Thesis/BackgroundEstimation/images/mbb_bbb_bbloose_bbanti_r200-215_normalized.pdf}
%  \label{fig:mbb_data}
...
%\tablewidth{0pc}
%\tablecolumns{4}
%\tablecaption{Matrix method predictions for the flavor contents of the QCD background\label{tab:mm_predictions}}
%\tablehead{
%\colhead{jets in event} & \colhead{b prediction} & \colhead{c prediction} & \colhead{light prediction}  }
%\startdata
%inclusive & 0.046 & 0.11 & 0.84\\
%3-jet & 0.039 & 0.11 & 0.85\\
%4-jet & 0.046 & 0.10 & 0.85\\
%5-jet & 0.049 & 0.11 & 0.84\\
%\enddata
%\end{deluxetable}
