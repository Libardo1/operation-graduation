...
\begin{figure}
    \center
	\includegraphics[width=0.7\textwidth]{TriggerCuts/L2_EF.pdf}\\	
	\includegraphics[width=0.7\textwidth]{TriggerCuts/EF_MV1.pdf}	
    \caption{The correlation between the $b$-tagging in Level 2 of the
    trigger and the trigger Event Filter. \label{fig:L2_EF}}
\end{figure}
