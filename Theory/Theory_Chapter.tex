...
\begin{figure}
    ...
    $A$, $H$ and $h$ as a function of $m_A$ for several different values of $\tan\beta$ (denoted ``tb'' in the legend). 
...
\begin{figure}
	...
	\caption{The inherent width of $A$, $H$, and $h$ as a function of tan$\beta$ in the $m_h^{max}$ scenario when $m_A$=500 GeV. 
...
for $H^\pm$ can constrain the likely MSSM phase space available for $H$ and $A$ (Figure~\ref{fig:susy_higgs_masses}).
    In practice, the mass regime probed by this analysis (400-800 GeV) is not
