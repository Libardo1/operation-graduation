...
%figure taken from here: http://inspirehep.net/record/810987?ln=en
%\begin{figure}
%	\includegraphics[width=0.8\textwidth]{/Users/caitlinmalone/Documents/Thesis/Theory/figures/bra-mssm.pdf}
%	\label{fig:bra-mssm}
%\end{figure}
%
%figure taken from here: http://inspirehep.net/record/810987?ln=en
%\begin{figure}
%	\includegraphics[width=0.8\textwidth]{/Users/caitlinmalone/Documents/Thesis/Theory/figures/brh-mssm.pdf}
%	\label{fig:brh-mssm}
%\end{figure}
%
%figure taken from here: http://inspirehep.net/record/810987?ln=en
%\begin{figure}
%	\includegraphics[width=0.8\textwidth]{/Users/caitlinmalone/Documents/Thesis/Theory/figures/h_width.pdf}
%	\label{fig:h_width}
%\end{figure}
